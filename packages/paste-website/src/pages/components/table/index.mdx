...
A Table is used to represent tabular data – that is, information presented in a 2-dimensional table composed of rows and columns of cells containing data.
...
Table cells (`Td` or `Th`) can be given a width in order to fill a section of the Table row (`Tr`). Widths can be set with Paste Size Tokens or a number value, e.g. 120px.
...
<LivePreview scope={{Table, THead, TBody, Tr, Th, Td}} language="jsx">
  ...
  <THead>
    <Tr>
      <Th>First Name</Th>
      <Th alignment="right">Last Name</Th>
    </Tr>
  </THead>
  <TBody>
    <Tr>
      <Td>Tamir</Td>
      <Td alignment="right">Rice</Td>
    </Tr>
    <Tr>
      <Td>Philando</Td>
      <Td alignment="right">Castile</Td>
    </Tr>
    <Tr>
      <Td>Trayvon</Td>
      <Td alignment="right">Martin</Td>
    </Tr>
    <Tr>
      <Td>Breonna</Td>
      <Td alignment="right">Taylor</Td>
    </Tr>
    <Tr>
      <Td>Shantel</Td>
      <Td alignment="right">Davis</Td>
    </Tr>
    <Tr>
      <Td>Walter</Td>
      <Td alignment="right">Scott</Td>
    </Tr>
  </TBody>
</Table>`}
</LivePreview>
...
| padding     | space-40, First - padding-left: space-50, Last - padding-right: space-50 | No          |
...
const TableExample: React.FC = () => {
  return (
    <Table variant="fixed">
      <THead>
        <Tr verticalAlignment="middle">
          <Th width="size40"alignment="left">Column 1</Th>
          <Th>Column 2</Th>
        </Tr>
      </THead>
      <TBody>
...
Sets the alignment of the content within the Table cell. Defaults to `left`.
